...
<div class="card border-0 shadow-sm rounded">
    <div class="card-body">
        <form action="<?php echo e(route('admin.reservasi.store')); ?>" method="POST"  >
          <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            ...
            <input type="date" name="tanggal_mulai" class="form-control" id="exampleInputPassword1" placeholder="Tanggal">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            ...
            <input type="date" name="tanggal_akhir" class="form-control" id="exampleInputPassword1" placeholder="Tanggal">
...
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Downloads\pemesananHotel\resources\views/levelAdmin/reservasi/create.blade.php ENDPATH**/ ?>