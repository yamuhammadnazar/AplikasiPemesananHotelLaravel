...
<div class="card border-0 shadow-sm rounded">
    <div class="card-body">
        <form action="<?php echo e(route('admin.pembayaran.update', $pembayaran->id_payment)); ?>" method="POST"  >
          <?php echo csrf_field(); ?>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="customer_id" id="exampleFormControlSelect1">
              <option value="<?php echo e(old('nama_barang', $pembayaran->customer_id)); ?>"><?php echo e(old('nama_barang', $pembayaran->customer_id)); ?></option>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            ...
            <input type="date" name="tanggal" class="form-control" id="exampleInputPassword1" placeholder="Tanggal" value="<?php echo e(old('nama_barang', $pembayaran->tanggal)); ?>">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="metode_bayar" id="exampleFormControlSelect1">
              <option value="<?php echo e(old('nama_barang', $pembayaran->metode_bayar)); ?>"><?php echo e(old('nama_barang', $pembayaran->metode_bayar)); ?></option>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="id_invoice" id="exampleFormControlSelect1">
              <option value="<?php echo e(old('nama_barang', $pembayaran->id_invoice)); ?>"><?php echo e(old('nama_barang', $pembayaran->id_invoice)); ?></option>
...
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Downloads\pemesananHotel\resources\views/levelAdmin/pembayaran/edit.blade.php ENDPATH**/ ?>