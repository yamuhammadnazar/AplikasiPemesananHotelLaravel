    ...
    <div class="card-body">
        <form action="{{ route('admin.invoice.update', $invoice->id_invoice) }}" method="POST"  >
          ...
          <div class="form-group">
            ...
            <input type="text" name="deskripsi" class="form-control" id="exampleInputPassword1" placeholder="Deskripsi" value="{{ old('nama_barang', $invoice->deskripsi)}}">
            @error('deskripsi')
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="status" id="exampleFormControlSelect1">
              <option value="{{ old('nama_barang', $invoice->status)}}">{{ old('nama_barang', $invoice->status)}}</option>
          ...
          <div class="form-group">
            ...
            <input type="number" name="besar_dp" class="form-control" id="exampleInputPassword1" placeholder="enter" value="{{ old('nama_barang', $invoice->besar_dp)}}" >
            @error('besar_dp')
            <div class="alert alert-danger mt-2">
                {{ $message }}
            </div>
